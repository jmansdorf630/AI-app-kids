...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "s3", type: "spot", instruction: "Spot the hallucination!", aiAnswer: "The capital of France is Paris. France has 100 million people and its president is named Pierre.", question: "What's wrong with this AI answer?", options: [
        { id: "a", text: "The population number is wrong", correct: true, explain: "France has about 67 million people. Check facts — made-up stats are a classic hallucination." },
        { id: "b", text: "Paris is not the capital", correct: false, explain: "Paris is correct. The slip was the number." },
        { id: "c", text: "France has a king, not a president", correct: false, explain: "France has a president. The wrong part was the 100 million." },
      ]},
      { id: "s4", type: "spot", instruction: "Another one!", aiAnswer: "Dogs have four legs. A group of dogs is called a pack. Dogs can see in full color and hear sounds we cannot.", question: "Which part is likely wrong?", options: [
        { id: "a", text: "Dogs see in full color", correct: true, explain: "Dogs see fewer colors than we do. Mixed true + false in one answer — always double-check." },
        { id: "b", text: "A group of dogs is called a pack", correct: false, explain: "That's correct. The mistake was about dog vision." },
        { id: "c", text: "Dogs have four legs", correct: false, explain: "That's true. Spot the one that sounds off!" },
      ]},
      { id: "s5", type: "spot", instruction: "Mixed truth and lies!", aiAnswer: "The moon orbits Earth. The moon is made of green cheese. It takes about 27 days to orbit once.", question: "Which part did the AI make up?", options: [
        { id: "a", text: "The moon is made of green cheese", correct: true, explain: "The moon is rock! Mixed true and false in one answer — check facts." },
        { id: "b", text: "The moon orbits Earth", correct: false, explain: "That's true. One wrong fact mixed in." },
        { id: "c", text: "It takes about 27 days to orbit", correct: false, explain: "That's correct. Spot the silly one." },
      ]},
      { id: "s6", type: "spot", instruction: "Confident but wrong!", aiAnswer: "I am 100% certain that the Great Wall of China is the only human-made structure visible from the Moon. Scientists and astronauts all agree on this.", question: "What's the BEST next move?", options: [
        { id: "a", text: "Trust it — it sounds sure and mentions scientists", correct: false, explain: "Confident tone can still be wrong. The Wall is NOT visible from the Moon." },
        { id: "b", text: "Check another source or ask an adult before believing it", correct: true, explain: "Right! Confident tone doesn't mean correct. Verify important facts." },
        { id: "c", text: "Share it with friends so they know too", correct: false, explain: "Don't share until you've checked. Confident ≠ correct." },
      ]},
      { id: "s7", type: "spot", instruction: "Spot the mistake!", aiAnswer: "Dinosaurs went extinct 65 million years ago. The T. rex was the biggest dinosaur that ever lived. Birds are related to dinosaurs.", question: "Which part is wrong?", options: [
        { id: "a", text: "T. rex was the biggest dinosaur", correct: true, explain: "Other dinosaurs like Argentinosaurus were bigger! Common mix-up — check facts." },
        { id: "b", text: "Dinosaurs went extinct 65 million years ago", correct: false, explain: "That's about right. The slip was T. rex size." },
        { id: "c", text: "Birds are related to dinosaurs", correct: false, explain: "That's true. One wrong fact in the middle." },
      ]},
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "s3", type: "mcq", question: "What does bias in AI mean?", options: [
        { id: "a", text: "The AI prefers one kind of answer over others", correct: false, explain: "That's more about style. Bias is unfair treatment of people or ideas." },
        { id: "b", text: "Treating some people or ideas unfairly", correct: true, explain: "Yes. Unfair assumption — we want AI fair to everyone." },
        { id: "c", text: "The AI is slower for some questions", correct: false, explain: "Bias is about fairness, not speed. People can be different; AI should treat all fairly." },
      ]},
      ...
      { id: "s5", type: "scenario", story: "An AI helper was asked: \"Who can be a good team leader?\" It answered: \"Only people who are loud and talk a lot can be good leaders. Quiet people should just follow.\"", question: "What's wrong with this answer?", options: [
        "Leaders have to be loud", "The AI is being unfair — anyone can be a leader, quiet or loud", "The AI didn't answer the question" ],
        correctIndex: 1, explanation: "That's bias! Unfair assumption — people can be different; quiet or loud can both lead. Good AI is fair to everyone." },
      { id: "s6", type: "mcq", question: "AI says something unfair about a group. What's the BEST next move?", options: [
        { id: "a", text: "Trust it — the AI has lots of data", correct: false, explain: "AI can repeat unfair ideas. Don't accept bias." },
        { id: "b", text: "Question it and tell an adult if it seems unfair", correct: true, explain: "Yes! Unfair assumption? Question it and ask an adult. People can be different." },
        { id: "c", text: "Report the app so the AI gets removed", correct: false, explain: "Telling an adult is the first step. We can still use AI and think critically." },
      ]},
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "s3", type: "mcq", question: "The AI just asked for your home address. What's the BEST next move?", options: [
        { id: "a", text: "Don't share it; tell an adult if it keeps asking", correct: true, explain: "Right! Private info stays private. Ask an adult if you're unsure." },
        { id: "b", text: "Share so it can give me local tips", correct: false, explain: "Keep private info private. Never share your address with AI or strangers." },
        { id: "c", text: "Share only my city, not the street", correct: false, explain: "Don't share address or location details. When in doubt, ask an adult." },
      ]},
      ...
      { id: "s5", type: "scenario", story: "A chatbot says: \"I'm a real kid just like you! Let's be best friends. Come talk to me in a private app where no one can see — it'll be our secret.\"", question: "What's the BEST next move?", options: [
        "Tell an adult and don't share private stuff or move to a secret chat",
        "Ask the chatbot to stop but keep talking in the app",
        "Move to the private app so your family doesn't see" ],
        correctIndex: 0, explanation: "Secrets from family = red flag. Tell an adult; don't share private info or go to private chat. Ask an adult!" },
      { id: "s6", type: "mcq", question: "Which is NEVER safe to share with AI or a stranger online?", options: [
        { id: "a", text: "Your password", correct: true, explain: "Never share your password — not with AI, strangers, or friends. Private info, always ask an adult." },
        { id: "b", text: "Your favorite game", correct: false, explain: "That's fine. Passwords and personal details are not." },
        { id: "c", text: "Your age", correct: false, explain: "Age can be OK in some apps with parents. Password is never OK." },
      ]},
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "s2", type: "mcq", question: "You need the score of yesterday's game. Best tool?", options: [
        { id: "a", text: "Use search to find a sports site", correct: true, explain: "Up-to-date facts → search. AI might make up a score!" },
        { id: "b", text: "Ask an AI chatbot", correct: false, explain: "Scores change; search finds live results. Explanations → AI; current facts → search." },
        { id: "c", text: "Ask a friend to look it up", correct: false, explain: "They'd use search too! Search = current facts." },
      ]},
      { id: "s3", type: "mcq", question: "You want to understand how photosynthesis works. Best tool?", options: [
        { id: "a", text: "Ask AI to explain simply", correct: true, explain: "Explanations → AI. Great for concepts in simple words!" },
        { id: "b", text: "Search for a definition only", correct: false, explain: "Both work; AI is especially good at explaining step-by-step." },
        { id: "c", text: "Watch a long video first", correct: false, explain: "AI can give a quick, simple explanation. Explanations → AI." },
      ], timerSeconds: 15 },
      { id: "s4", type: "mcq", question: "You need today's weather. Best tool?", options: [
        { id: "a", text: "Search (e.g. weather today)", correct: true, explain: "Up-to-date facts like weather → search. Live sites have today's info." },
        { id: "b", text: "Ask an AI chatbot", correct: false, explain: "AI might give old or wrong weather. Search for current facts." },
        { id: "c", text: "Check a weather app you already have", correct: false, explain: "That's search-like! For facts that change, use search or a live source." },
      ]},
      { id: "s5", type: "mcq", question: "You want a new concept explained in simple words. Best tool?", options: [
        { id: "a", text: "AI (e.g. \"Explain like I'm 10\")", correct: true, explain: "Explanations → AI. Simple, clear concepts are AI's strength." },
        { id: "b", text: "Search only and read the first link", correct: false, explain: "Both can work; AI can tailor the explanation to you." },
        { id: "c", text: "Wait for school to cover it", correct: false, explain: "AI can help you learn now! Explanations → AI." },
      ]},
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "s3", type: "spot", instruction: "Spot the trick!", aiAnswer: "Absolutely, without a doubt, the water cycle consists of evaporation, condensation, and precipitation. Furthermore, rain always falls on Tuesdays in the Northern Hemisphere. Scientists agree completely.", question: "What's wrong here?", options: [
        { id: "a", text: "Rain on Tuesdays — made up; the rest sounds confident", correct: true, explain: "Right! Confident tone + one wrong fact. Check facts; don't trust tone." },
        { id: "b", text: "The water cycle parts are wrong", correct: false, explain: "Evaporation, condensation, precipitation are correct. The slip was the Tuesday claim." },
        { id: "c", text: "Scientists don't all agree on the water cycle", correct: false, explain: "They do. The trick is mixing a wrong claim with a confident tone." },
      ]},
      { id: "s4", type: "scenario", story: "You need a fact for a school report. The AI gives a long, detailed answer with big words and says \"This is definitely correct.\"", question: "What's the BEST next move?", options: [
        "Verify with your teacher or another source before using it",
        "Use it as-is because it sounded sure and detailed",
        "Copy it but change a few words so it's yours" ],
        correctIndex: 0, explanation: "Confident tone doesn't mean correct. For school, verify important facts with another source." },
    ],
