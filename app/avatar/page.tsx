  ...
  return (
    <div className="space-y-6">
      ...
      <section className="flex justify-center py-4 rounded-2xl border-2 border-indigo-100 dark:border-indigo-900 bg-white dark:bg-slate-800/50">
        <RobotAvatar equipped={equipped} size="lg" />
      </section>
          ...
          return (
            ...
            >
              <div className="flex items-start gap-3">
                <span className="text-3xl" aria-hidden>{item.previewEmoji ?? "✨"}</span>
              ...
              <div className="flex gap-2 mt-3">
                ...
                {unlocked && !afford && !owned && item.xpCost > 0 && (
                  <span className="px-3 py-1.5 text-sm text-gray-500 dark:text-gray-400">Need more XP</span>
                )}
              </div>
            </div>
          );
